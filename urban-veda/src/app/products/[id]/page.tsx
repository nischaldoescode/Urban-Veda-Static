...
export default async function ProductDetailPage({
  ...
  return (
    <div className="min-h-screen bg-white pb-32">
      <div className="max-w-7xl mx-auto px-6 pt-24 sm:pt-28">
        {/* back navigation */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          <ScrollReveal delay={0.1} direction="left">
            {/* product image — smaller on mobile, full on desktop */}
            <div className="flex justify-center lg:block">
              <div className="relative rounded-2xl sm:rounded-[2.5rem] lg:rounded-[3rem] overflow-hidden shadow-2xl aspect-[3/4] w-[72vw] sm:w-[56vw] lg:w-full group">
                <ImageModal
                  src={juice.image}
                  alt={juice.name}
          ...
          {/* closes flex justify-center div */}
