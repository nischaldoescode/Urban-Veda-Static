...
import {
  Leaf, Shield, Users, Eye, Sparkles, Heart,
  Zap, ShieldCheck, FlameKindling, Star
} from "lucide-react";

export const metadata: Metadata = {
  metadataBase: new URL("https://urbanveda.com"),
  title: "About Us",
  description: "The Urban Veda story — bridging ancient wisdom with modern life.",
};

const iconMap: Record<string, React.ComponentType<{ size?: number; className?: string }>> = {
  Leaf, Shield, Users, Eye, Sparkles, Heart, Zap, ShieldCheck, FlameKindling, Star
};
