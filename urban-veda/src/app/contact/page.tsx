...
export default function ContactPage() {
    ...
    fetch("/api/config").then(r => r.json()).then(data => {
      if (data.success) {
        setContactInfo({
          ...
          location: data.data.contactInfo?.location || "sobha city, bangalore",
  ...
  const infoCards = [
    { icon: Phone, title: "phone", main: contactInfo.phone, sub: contactInfo.hours, href: `tel:${contactInfo.phone.replace(/\s/g, '')}` },
    { icon: Mail, title: "email", main: contactInfo.email, sub: "we respond within 24 hours", href: `mailto:${contactInfo.email}` },
    { icon: MapPin, title: "location", main: contactInfo.location, sub: "currently delivering here", href: undefined },
  ];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-28 sm:pt-32 pb-16 sm:pb-20">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-500 max-w-lg mx-auto leading-relaxed">
            have questions about our juices? want to start your wellness journey? we'd love to hear from you.
          </p>
        </motion.div>
        ...
        >
          <div className="max-w-md mx-auto bg-gradient-to-br from-green-50 via-white to-olive/5 border border-green-100 rounded-2xl p-6 sm:p-7 text-center shadow-sm">
            ...
            <h3 className="font-bold text-sage-dark text-base mb-1.5">join our whatsapp community</h3>
            <p className="text-xs sm:text-sm text-gray-500 mb-4 max-w-xs mx-auto">
              daily wellness tips, exclusive offers, and connect with health enthusiasts in your neighborhood.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-start">
          ...
          <motion.div
            ...
            className="space-y-3"
          >
            <motion.h2 variants={itemVariants} className="text-xl font-bold text-sage-dark font-serif mb-4">
              reach out directly
            </motion.h2>
                  ...
                  <CardContent className="p-4 sm:p-5">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {href ? (
                          <a href={href} className="text-sm font-semibold text-gray-800 hover:text-olive transition-colors">{main}</a>
                        ) : (
              ...
              <CardContent className="p-5 sm:p-7">
                ...
                {isSuccess ? (
                  ...
                  >
                    ...
                    <h3 className="text-lg font-bold text-sage-dark mb-1">message sent!</h3>
