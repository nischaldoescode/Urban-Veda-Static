        ...
        {confirmState?.open && (
          <>
            ...
            <motion.div
              ...
              className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[9999] bg-white rounded-2xl shadow-2xl p-6 w-full max-w-sm mx-4"
            >
              {/* icon */}
              <div className={`w-11 h-11 rounded-2xl flex items-center justify-center mb-4 ${confirmState.options.danger ? 'bg-red-50' : 'bg-olive/10'}`}>
